hostnames = [
	...
	['app-1', '10.10.20.201', '22', 'mncnow', 'Usage: V+ APP'],
	['app-2', '10.10.20.202', '22', 'mncnow', 'Usage: V+ APP'],
	['app-3', '10.10.20.203', '22', 'mncnow', 'Usage: V+ APP'],
	['app-4', '10.10.20.204', '22', 'mncnow', 'Usage: V+ APP'],
	['app-5', '10.10.20.205', '22', 'mncnow', 'Usage: V+ APP'],
	['app-6', '10.10.20.206', '22', 'mncnow', 'Usage: V+ APP'],
	['app-7', '10.10.20.207', '22', 'mncnow', 'Usage: V+ APP'],
	['---------- V+ PRODUCTION WEB API ----------', '-----', '--', '----', '---------'],
	['web-1', '10.10.20.211', '22', 'mncnow', 'Usage: V+ Web API'],
	['web-2', '10.10.20.212', '22', 'mncnow', 'Usage: V+ Web API'],
	['web-3', '10.10.20.213', '22', 'mncnow', 'Usage: V+ Web API'],
	['web-4', '10.10.20.214', '22', 'mncnow', 'Usage: V+ Web API'],
	['web-5', '10.10.20.215', '22', 'mncnow', 'Usage: V+ Web API'],
	['web-6', '10.10.20.216', '22', 'mncnow', 'Usage: V+ Web API'],
	['---------- V+ PRODUCTION WEB  ----------', '-----', '--', '----', '---------'],
